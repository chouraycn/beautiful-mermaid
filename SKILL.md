...
> **AI 工作规则**：本文档包含 AI 助手的工作指南。如需查看详细的 AI 工作流程规则，请参考 `AI_GUIDELINES.md`。
>
> **核心原则**：
> - 新任务必须先打开 `preview.html` 让用户选择主题和预设
> - 用户明确说"继续"时才读取现有文件进行修改
> - 意图不确定时必须使用 `ask_followup_question` 确认
>
> 详细规则请参考 `AI_GUIDELINES.md`。
